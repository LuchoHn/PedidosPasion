...
<?php include_once("conexion/db_conexion.php"); ?>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="controladores/checklogin.php" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Usuario" name="form-username" required>
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Contraseña" name="form-password" required>
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="row">
          <!-- /.col -->
          <div class="col-md-12">
            <button type="submit" name="form-enviar" id="form-enviar" class="btn btn-primary btn-block">Iniciar Sesión</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
